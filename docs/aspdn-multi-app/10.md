...
| ![](../Images/tip.png) | 提示:即使我选择谈论会员提供商，我也绝不认为您应该在新的(绿地)开发中使用它。根据微软的说法，未来是[ASP.NET 身份](http://www.asp.net/identity)(至少目前是这样)，我强烈建议你进入其中。这里有一个关于如何从会员提供商迁移到 ASP.NET 身份的好帖子。 |
