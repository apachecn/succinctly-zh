...
| ![](../images/00006.gif) | 提示:用-h 标志设置容器的主机名使得使用 Hadoop 网络用户界面变得更加容易。您可以在 hosts 文件中添加一个条目，将 Docker 机器的 IP 地址与容器的主机名相关联，这意味着您可以浏览到 http://hadoop:8088 来检查作业状态。这样，Hadoop 生成的链接都可以正常工作。 |
