...
![](../images/00013.jpeg)注意:节俭原料药记录在。节俭档案。该文件没有附带 HBase 二进制文件，因此您需要从源代码中获取正确的版本。对于版本 1.1.2，文件在 GitHub [这里](https://github.com/apache/hbase/blob/cc2b70cf03e3378800661ec5cab11eb43fafe0fc/hbase-thrift/src/main/resources/org/apache/hadoop/hbase/thrift2/hbase.thrift)上。
...
![](../images/00012.jpeg)提示:节俭应用编程接口在 HBase 在线文档中有很好的记录，您需要提供的可用过滤器和参数在这里有所介绍。
...
![](../images/00015.jpeg)注意:批处理由节俭 API 支持，因此当发送一批更新(在本机节俭 API 中称为突变)时，这是在对节俭连接的单次调用中完成的。
